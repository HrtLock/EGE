...
print(f'Номер {num}.19')
def f(x, y, p):
    if x + y >= n and p == 3: # Выигрыш на 3-ем ходу игры
        return True
    elif x + y < n and p == 3: # Проигрыш на 3-ем ходу игры
        return False
...
print(f'Номер {num}.20')
def f(x, y, p):
    if x + y >= n and p == 4: # Выигрыш на 4-ом ходу игры
        return True
    else:
        if x + y < n and p == 4: # Проигрыш на 4-ом ходу игры
            return False
        elif x + y >= n: # Выигрыш на ином ходу игры
            return False
...
print(f'Номер {num}.21')
def f(x, y, p):
    if x + y >= n and (p == 3 or p == 5): # может выиграть на 3 или 5 ходу
        return True
    else:
        if x + y < n and p == 5: # не может проиграть на 5-ом ходу
            return False
        elif x + y >= n:
            return False
